...
document.addEventListener('DOMContentLoaded', () => {
 ...
 function getResponse(question) {
    ...
    // Includes: "beautiful", "scenic", "highlights"
    ...
    // Currency / Cost / Money
    // Includes: "pay", "affordable", "expensive", "budget", "credit card"
    ...
    // Food / Drink / Dining
    // Includes: "eat", "drink", "restaurant", "meal", "typical"
    if (q.includes('food') || q.includes('cuisine') || q.includes('dish') || q.includes('eat') || 
        ...
        q.includes('specialty') || q.includes('typical')) {
    ...
    // Includes: "what to do", "see", "trip", "excursion", "landmark"
    ...
    // Weather / Climate
    // Includes: "rain", "sun", "hot", "cold", "pack", "season"
    ...
    // Sahara / Desert
    // Includes: "dunes", "camel", "star wars", "tozeur", "douz"
    if (q.includes('sahara') || q.includes('desert') || q.includes('dunes') || q.includes('camel') || 
        q.includes('tozeur') || q.includes('douz') || q.includes('tatooine')) {
    ...
    // Language
    // Includes: "talk", "english", "french", "understand"
    if (q.includes('language') || q.includes('speak') || q.includes('talk') || q.includes('english') || 
        q.includes('french') || q.includes('communicate') || q.includes('understand')) {
    ...
    // History / Carthage
    // Includes: "past", "ancient", "ruins", "archaeology"
    ...
    // Includes: "emergency", "danger", "police", "risk"
    if (q.includes('safe') || q.includes('safety') || q.includes('secure') || q.includes('danger') || 
        ...
        q.includes('emergency') || q.includes('help')) {
        return "Tunisia is generally a safe destination for tourists. The Tunisian people are known for their warm hospitality and friendliness. As with any travel destination, use common sense, stay aware of your surroundings, and follow local advice. In case of emergency, the Tourist Police number is 197 and the general emergency number is 112.";
    }
    
    // Best time to visit
    // Includes: "when to go", "good time", "month"
    ...
    if (q.includes('hotel') || q.includes('accommodation') || q.includes('stay') || q.includes('sleep') || 
        q.includes('hostel') || q.includes('resort') || q.includes('riad') || q.includes('booking') || q.includes('lodge')) {
    ...
    // Includes: "bus", "train", "taxi", "car rental", "drive", "airport"
    ...
    if (q.includes('where is') || q.includes('location') || q.includes('continent') || q.includes('map') || 
        q.includes('border') || q.includes('africa') || q.includes('europe')) {
    ...
    if (q.includes('shopping') || q.includes('shop') || q.includes('buy') || q.includes('souvenir') || 
        ...
        q.includes('carpet') || q.includes('pottery')) {
    ...
    if (q.includes('visa') || q.includes('passport') || q.includes('entry') || q.includes('enter') || 
        q.includes('requirements') || q.includes('document')) {
